                        ...
                        <div className="flex flex-col flex-1 pt-3 pb-4 overflow-y-auto">
                            <div className="flex-1 px-3 space-y-1 bg-white divide-y divide-gray-200 ">
                                <ul className="">
                                    ...
                                    {/* Protected menu items - always visible but will redirect if not logged in */}
                                    {authStatus && (
                                    ...
                                    {/* Sign Up / Sign In links - only show when not logged in */}
                                    {!authStatus && (
                                        <>
                                            <div className='divide-y divide-gray-200' >
                                                <li>
                                                    <Link to={"/signup"} className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group ">
                                                        ...
                                                        <span className="ml-3" sidebar-toggle-item>Sign Up</span>
                                                    </Link>
                                                </li>
                                                <li>
                                                    <Link to={"/login"} className="flex items-center p-2 text-base text-gray-900 rounded-lg hover:bg-gray-100 group ">
                                                        ...
                                                        <span className="ml-3" sidebar-toggle-item>Sign In</span>
                                                    </Link>
                                                </li>
                                            </div>
                                        </>
                                    ...
                                    {/* Subscriptions list - only show when logged in */}
                                    {authStatus && (
                                        <div className=" pt-2">
                                            {loadingSubs ? (
