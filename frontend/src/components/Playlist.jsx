    ...
    return (
      <div className="lg:mt-8 bg-gray-50 min-h-screen flex items-center justify-center p-6">
        <div className="bg-white rounded-lg p-12 text-center shadow-sm max-w-md w-full">
          ...
          <h2 className="text-2xl font-semibold mb-4 text-gray-900">Sign in to access your playlists</h2>
          <p className="text-gray-600 mb-2">Your saved playlists will appear here after you sign in</p>
          <div className="mt-8">
            <Link 
              to="/login" 
