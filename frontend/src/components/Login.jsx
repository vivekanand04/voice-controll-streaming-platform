...
function Login() {
  ...
  <div className="relative inline-flex flex-col text-xs text-gray-600 bg-gray-100 rounded-md px-3 py-2 shadow-sm w-full sm:w-auto">
    <button
      type="button"
      onClick={handleFillDemoCredentials}
      className="absolute top-1 right-1 p-1 text-gray-500 hover:text-gray-700 hover:bg-gray-200 rounded transition-colors"
    ...
    <span className="font-semibold pr-6">Demo Login:</span>
